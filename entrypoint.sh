...
cat ~/.ssh/vault_key
echo ansible-playbook ${INVENTORY} ${VAULTFILE} ${KEYFILE} ${VERBOSITY} ${EXTRAFILE} ${INPUT_EXTRAVARS} ${INPUT_PLAYBOOKNAME}
ansible-playbook ${INVENTORY} ${VAILTFILE} ${KEYFILE} ${VERBOSITY} ${EXTRAFILE} ${INPUT_EXTRAVARS} ${INPUT_PLAYBOOKNAME}